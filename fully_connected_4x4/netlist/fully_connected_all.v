...
module fully_connected_all ( clk, rst_fsm, start, layer_fc, i_kernel1, 
  ...
  wire   tb_rst_cnt1, tb_en_cnt1, tb_rst_cnt2, tb_en_cnt2, tb_tc2, fc_s_en_pe,
         ...
         fc_clk_gating_unit_n5, fc_count_n57, fc_count_n56, fc_count_n55,
         fc_count_n54, fc_count_n53, fc_count_n52, fc_count_n51, fc_count_n50,
         fc_count_n49, fc_count_n46, fc_count_n24, fc_count_n23, fc_count_n22,
         ...
         fc_count_n11, fc_count_n10, fc_count_n9, fc_count_n8, fc_count_n7,
         fc_count_n5, fc_count_n4, fc_count_n3, fc_count_n2, fc_count_n1,
         fc_count_n48, fc_count_n47, fc_count_n45, fc_count_n44, fc_count_n43,
         fc_count_n42, fc_count_n41, fc_count_n40, fc_count_n39, fc_count_n38,
         fc_count_n37, fc_count_n36, fc_count_n35, fc_count_n34, fc_count_n33,
         fc_count_n32, fc_count_n31, fc_count_n30, fc_count_n29, fc_count_n28,
         fc_count_n27, fc_count_n26, fc_count_n25, fc_count_n6, fc_count_N25,
         fc_count_N24, fc_count_N23, fc_count_N21, fc_count_N19, fc_count_N18,
         fc_count_N17, fc_count_N16, fc_count_N15, fc_count_N14, fc_count_N13,
         fc_count_N12, fc_count_N11, fc_count_N10, fc_count_N9, fc_count2_n23,
         fc_count2_n18, fc_count2_n17, fc_count2_n15, fc_count2_n13,
         fc_count2_n12, fc_count2_n11, fc_count2_n9, fc_count2_n6,
         fc_count2_n4, fc_count2_n3, fc_count2_n2, fc_count2_n1, fc_count2_n39,
         fc_count2_n38, fc_count2_n36, fc_count2_n35, fc_count2_n34,
         fc_count2_n33, fc_count2_n32, fc_count2_n31, fc_count2_n29,
         fc_count2_n28, fc_count2_n25, fc_count2_n24, fc_count2_n22,
         fc_count2_n21, fc_count2_n20, fc_count2_n19, fc_count2_n16,
         fc_count2_n14, fc_count2_n10, fc_count2_n8, fc_count2_n7,
         fc_count2_n5, fc_mux_n2, fc_mux_n3, fc_mux2_n1, fsm_n3, fsm_n9,
         fsm_n8, fsm_n7, fsm_n6, fsm_n5, fsm_n4;
  ...
  AND2_X1 fc_pe_b_peij_0_0_U21 ( .A1(i_kernel1[7]), .A2(fc_pe_b_peij_0_0_n1), 
        .ZN(fc_pe_b_peij_0_0_n19) );
  AND2_X1 fc_pe_b_peij_0_0_U20 ( .A1(fc_pe_b_peij_0_0_d_acc[0]), .A2(
        fc_pe_b_peij_0_0_n1), .ZN(fc_pe_b_peij_0_0_n14) );
  AND2_X1 fc_pe_b_peij_0_0_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_0_0_n3), 
        .ZN(fc_pe_b_peij_0_0_n18) );
  AND2_X1 fc_pe_b_peij_0_0_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_0_0_n3), 
        .ZN(fc_pe_b_peij_0_0_n17) );
  AND2_X1 fc_pe_b_peij_0_0_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_0_0_n3), 
  ...
  AND2_X1 fc_pe_b_peij_0_1_U21 ( .A1(i_kernel1[5]), .A2(fc_pe_b_peij_0_1_n1), 
        .ZN(fc_pe_b_peij_0_1_n20) );
  AND2_X1 fc_pe_b_peij_0_1_U20 ( .A1(fc_pe_b_peij_0_1_d_acc[0]), .A2(
        fc_pe_b_peij_0_1_n1), .ZN(fc_pe_b_peij_0_1_n25) );
  AND2_X1 fc_pe_b_peij_0_1_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_0_1_n36), 
        .ZN(fc_pe_b_peij_0_1_n21) );
  AND2_X1 fc_pe_b_peij_0_1_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_0_1_n36), 
        .ZN(fc_pe_b_peij_0_1_n22) );
  AND2_X1 fc_pe_b_peij_0_1_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_0_1_n36), 
  ...
  AND2_X1 fc_pe_b_peij_0_2_U21 ( .A1(i_kernel1[3]), .A2(fc_pe_b_peij_0_2_n1), 
        .ZN(fc_pe_b_peij_0_2_n20) );
  AND2_X1 fc_pe_b_peij_0_2_U20 ( .A1(fc_pe_b_peij_0_2_d_acc[0]), .A2(
        fc_pe_b_peij_0_2_n1), .ZN(fc_pe_b_peij_0_2_n25) );
  AND2_X1 fc_pe_b_peij_0_2_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_0_2_n36), 
        .ZN(fc_pe_b_peij_0_2_n21) );
  AND2_X1 fc_pe_b_peij_0_2_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_0_2_n36), 
        .ZN(fc_pe_b_peij_0_2_n22) );
  AND2_X1 fc_pe_b_peij_0_2_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_0_2_n36), 
  ...
  AND2_X1 fc_pe_b_peij_0_3_U21 ( .A1(i_kernel1[1]), .A2(fc_pe_b_peij_0_3_n1), 
        .ZN(fc_pe_b_peij_0_3_n20) );
  AND2_X1 fc_pe_b_peij_0_3_U20 ( .A1(fc_pe_b_peij_0_3_d_acc[0]), .A2(
        fc_pe_b_peij_0_3_n1), .ZN(fc_pe_b_peij_0_3_n25) );
  AND2_X1 fc_pe_b_peij_0_3_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_0_3_n36), 
        .ZN(fc_pe_b_peij_0_3_n21) );
  AND2_X1 fc_pe_b_peij_0_3_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_0_3_n36), 
        .ZN(fc_pe_b_peij_0_3_n22) );
  AND2_X1 fc_pe_b_peij_0_3_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_0_3_n36), 
  ...
  AND2_X1 fc_pe_b_peij_1_0_U21 ( .A1(i_kernel2[7]), .A2(fc_pe_b_peij_1_0_n1), 
        .ZN(fc_pe_b_peij_1_0_n20) );
  AND2_X1 fc_pe_b_peij_1_0_U20 ( .A1(fc_pe_b_peij_1_0_d_acc[0]), .A2(
        fc_pe_b_peij_1_0_n1), .ZN(fc_pe_b_peij_1_0_n25) );
  AND4_X1 fc_pe_b_peij_1_0_U19 ( .A1(i_kernel2[6]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[11]), .A4(fc_pe_b_peij_1_0_n1), .ZN(
        fc_pe_b_peij_1_0_n24) );
  AND2_X1 fc_pe_b_peij_1_0_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_1_0_n36), 
        .ZN(fc_pe_b_peij_1_0_n21) );
  AND2_X1 fc_pe_b_peij_1_0_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_1_0_n36), 
        .ZN(fc_pe_b_peij_1_0_n22) );
  AND2_X1 fc_pe_b_peij_1_0_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_1_0_n36), 
  ...
  AND2_X1 fc_pe_b_peij_1_1_U21 ( .A1(i_kernel2[5]), .A2(fc_pe_b_peij_1_1_n1), 
        .ZN(fc_pe_b_peij_1_1_n20) );
  AND2_X1 fc_pe_b_peij_1_1_U20 ( .A1(fc_pe_b_peij_1_1_d_acc[0]), .A2(
        fc_pe_b_peij_1_1_n1), .ZN(fc_pe_b_peij_1_1_n25) );
  AND4_X1 fc_pe_b_peij_1_1_U19 ( .A1(i_kernel2[4]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[10]), .A4(fc_pe_b_peij_1_1_n1), .ZN(
        fc_pe_b_peij_1_1_n24) );
  AND2_X1 fc_pe_b_peij_1_1_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_1_1_n36), 
        .ZN(fc_pe_b_peij_1_1_n21) );
  AND2_X1 fc_pe_b_peij_1_1_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_1_1_n36), 
        .ZN(fc_pe_b_peij_1_1_n22) );
  AND2_X1 fc_pe_b_peij_1_1_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_1_1_n36), 
  ...
  AND2_X1 fc_pe_b_peij_1_2_U21 ( .A1(i_kernel2[3]), .A2(fc_pe_b_peij_1_2_n1), 
        .ZN(fc_pe_b_peij_1_2_n20) );
  AND2_X1 fc_pe_b_peij_1_2_U20 ( .A1(fc_pe_b_peij_1_2_d_acc[0]), .A2(
        fc_pe_b_peij_1_2_n1), .ZN(fc_pe_b_peij_1_2_n25) );
  AND4_X1 fc_pe_b_peij_1_2_U19 ( .A1(i_kernel2[2]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[9]), .A4(fc_pe_b_peij_1_2_n1), .ZN(
        fc_pe_b_peij_1_2_n24) );
  AND2_X1 fc_pe_b_peij_1_2_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_1_2_n36), 
        .ZN(fc_pe_b_peij_1_2_n21) );
  AND2_X1 fc_pe_b_peij_1_2_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_1_2_n36), 
        .ZN(fc_pe_b_peij_1_2_n22) );
  AND2_X1 fc_pe_b_peij_1_2_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_1_2_n36), 
  ...
  AND2_X1 fc_pe_b_peij_1_3_U21 ( .A1(i_kernel2[1]), .A2(fc_pe_b_peij_1_3_n1), 
        .ZN(fc_pe_b_peij_1_3_n20) );
  AND2_X1 fc_pe_b_peij_1_3_U20 ( .A1(fc_pe_b_peij_1_3_d_acc[0]), .A2(
        fc_pe_b_peij_1_3_n1), .ZN(fc_pe_b_peij_1_3_n25) );
  AND4_X1 fc_pe_b_peij_1_3_U19 ( .A1(i_kernel2[0]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[8]), .A4(fc_pe_b_peij_1_3_n1), .ZN(
        fc_pe_b_peij_1_3_n24) );
  AND2_X1 fc_pe_b_peij_1_3_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_1_3_n36), 
        .ZN(fc_pe_b_peij_1_3_n21) );
  AND2_X1 fc_pe_b_peij_1_3_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_1_3_n36), 
        .ZN(fc_pe_b_peij_1_3_n22) );
  AND2_X1 fc_pe_b_peij_1_3_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_1_3_n36), 
  ...
  AND2_X1 fc_pe_b_peij_2_0_U21 ( .A1(i_kernel3[7]), .A2(fc_pe_b_peij_2_0_n1), 
        .ZN(fc_pe_b_peij_2_0_n20) );
  AND2_X1 fc_pe_b_peij_2_0_U20 ( .A1(fc_pe_b_peij_2_0_d_acc[0]), .A2(
        fc_pe_b_peij_2_0_n1), .ZN(fc_pe_b_peij_2_0_n25) );
  AND2_X1 fc_pe_b_peij_2_0_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_2_0_n36), 
        .ZN(fc_pe_b_peij_2_0_n21) );
  AND2_X1 fc_pe_b_peij_2_0_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_2_0_n36), 
        .ZN(fc_pe_b_peij_2_0_n22) );
  AND2_X1 fc_pe_b_peij_2_0_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_2_0_n36), 
  ...
  AND2_X1 fc_pe_b_peij_2_1_U21 ( .A1(i_kernel3[5]), .A2(fc_pe_b_peij_2_1_n1), 
        .ZN(fc_pe_b_peij_2_1_n20) );
  AND2_X1 fc_pe_b_peij_2_1_U20 ( .A1(fc_pe_b_peij_2_1_d_acc[0]), .A2(
        fc_pe_b_peij_2_1_n1), .ZN(fc_pe_b_peij_2_1_n25) );
  AND2_X1 fc_pe_b_peij_2_1_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_2_1_n36), 
        .ZN(fc_pe_b_peij_2_1_n21) );
  AND2_X1 fc_pe_b_peij_2_1_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_2_1_n36), 
        .ZN(fc_pe_b_peij_2_1_n22) );
  AND2_X1 fc_pe_b_peij_2_1_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_2_1_n36), 
  ...
  AND2_X1 fc_pe_b_peij_2_2_U21 ( .A1(i_kernel3[3]), .A2(fc_pe_b_peij_2_2_n1), 
        .ZN(fc_pe_b_peij_2_2_n20) );
  AND2_X1 fc_pe_b_peij_2_2_U20 ( .A1(fc_pe_b_peij_2_2_d_acc[0]), .A2(
        fc_pe_b_peij_2_2_n1), .ZN(fc_pe_b_peij_2_2_n25) );
  AND2_X1 fc_pe_b_peij_2_2_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_2_2_n36), 
        .ZN(fc_pe_b_peij_2_2_n21) );
  AND2_X1 fc_pe_b_peij_2_2_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_2_2_n36), 
        .ZN(fc_pe_b_peij_2_2_n22) );
  AND2_X1 fc_pe_b_peij_2_2_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_2_2_n36), 
  ...
  AND2_X1 fc_pe_b_peij_2_3_U21 ( .A1(i_kernel3[1]), .A2(fc_pe_b_peij_2_3_n1), 
        .ZN(fc_pe_b_peij_2_3_n20) );
  AND2_X1 fc_pe_b_peij_2_3_U20 ( .A1(fc_pe_b_peij_2_3_d_acc[0]), .A2(
        fc_pe_b_peij_2_3_n1), .ZN(fc_pe_b_peij_2_3_n25) );
  AND2_X1 fc_pe_b_peij_2_3_U19 ( .A1(i_data[3]), .A2(fc_pe_b_peij_2_3_n36), 
        .ZN(fc_pe_b_peij_2_3_n21) );
  AND2_X1 fc_pe_b_peij_2_3_U18 ( .A1(i_data[2]), .A2(fc_pe_b_peij_2_3_n36), 
        .ZN(fc_pe_b_peij_2_3_n22) );
  AND2_X1 fc_pe_b_peij_2_3_U17 ( .A1(i_data[1]), .A2(fc_pe_b_peij_2_3_n36), 
  ...
  AND2_X1 fc_pe_b_peij_3_0_U21 ( .A1(i_kernel4[7]), .A2(fc_pe_b_peij_3_0_n1), 
        .ZN(fc_pe_b_peij_3_0_n20) );
  AND2_X1 fc_pe_b_peij_3_0_U20 ( .A1(fc_pe_b_peij_3_0_d_acc[0]), .A2(
        fc_pe_b_peij_3_0_n1), .ZN(fc_pe_b_peij_3_0_n25) );
  AND4_X1 fc_pe_b_peij_3_0_U19 ( .A1(i_kernel4[6]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[3]), .A4(fc_pe_b_peij_3_0_n1), .ZN(
        fc_pe_b_peij_3_0_n24) );
  AND2_X1 fc_pe_b_peij_3_0_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_3_0_n36), 
        .ZN(fc_pe_b_peij_3_0_n21) );
  AND2_X1 fc_pe_b_peij_3_0_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_3_0_n36), 
        .ZN(fc_pe_b_peij_3_0_n22) );
  AND2_X1 fc_pe_b_peij_3_0_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_3_0_n36), 
  ...
  AND2_X1 fc_pe_b_peij_3_1_U21 ( .A1(i_kernel4[5]), .A2(fc_pe_b_peij_3_1_n1), 
        .ZN(fc_pe_b_peij_3_1_n20) );
  AND2_X1 fc_pe_b_peij_3_1_U20 ( .A1(fc_pe_b_peij_3_1_d_acc[0]), .A2(
        fc_pe_b_peij_3_1_n1), .ZN(fc_pe_b_peij_3_1_n25) );
  AND4_X1 fc_pe_b_peij_3_1_U19 ( .A1(i_kernel4[4]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[2]), .A4(fc_pe_b_peij_3_1_n1), .ZN(
        fc_pe_b_peij_3_1_n24) );
  AND2_X1 fc_pe_b_peij_3_1_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_3_1_n36), 
        .ZN(fc_pe_b_peij_3_1_n21) );
  AND2_X1 fc_pe_b_peij_3_1_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_3_1_n36), 
        .ZN(fc_pe_b_peij_3_1_n22) );
  AND2_X1 fc_pe_b_peij_3_1_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_3_1_n36), 
  ...
  AND2_X1 fc_pe_b_peij_3_2_U21 ( .A1(i_kernel4[3]), .A2(fc_pe_b_peij_3_2_n1), 
        .ZN(fc_pe_b_peij_3_2_n20) );
  AND2_X1 fc_pe_b_peij_3_2_U20 ( .A1(fc_pe_b_peij_3_2_d_acc[0]), .A2(
        fc_pe_b_peij_3_2_n1), .ZN(fc_pe_b_peij_3_2_n25) );
  AND4_X1 fc_pe_b_peij_3_2_U19 ( .A1(i_kernel4[2]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[1]), .A4(fc_pe_b_peij_3_2_n1), .ZN(
        fc_pe_b_peij_3_2_n24) );
  AND2_X1 fc_pe_b_peij_3_2_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_3_2_n36), 
        .ZN(fc_pe_b_peij_3_2_n21) );
  AND2_X1 fc_pe_b_peij_3_2_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_3_2_n36), 
        .ZN(fc_pe_b_peij_3_2_n22) );
  AND2_X1 fc_pe_b_peij_3_2_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_3_2_n36), 
  ...
  AND2_X1 fc_pe_b_peij_3_3_U21 ( .A1(i_kernel4[1]), .A2(fc_pe_b_peij_3_3_n1), 
        .ZN(fc_pe_b_peij_3_3_n20) );
  AND2_X1 fc_pe_b_peij_3_3_U20 ( .A1(fc_pe_b_peij_3_3_d_acc[0]), .A2(
        fc_pe_b_peij_3_3_n1), .ZN(fc_pe_b_peij_3_3_n25) );
  AND4_X1 fc_pe_b_peij_3_3_U19 ( .A1(i_kernel4[0]), .A2(i_data[0]), .A3(
        fc_pe_b_int_pe_en[0]), .A4(fc_pe_b_peij_3_3_n1), .ZN(
        fc_pe_b_peij_3_3_n24) );
  AND2_X1 fc_pe_b_peij_3_3_U18 ( .A1(i_data[3]), .A2(fc_pe_b_peij_3_3_n36), 
        .ZN(fc_pe_b_peij_3_3_n21) );
  AND2_X1 fc_pe_b_peij_3_3_U17 ( .A1(i_data[2]), .A2(fc_pe_b_peij_3_3_n36), 
        .ZN(fc_pe_b_peij_3_3_n22) );
  AND2_X1 fc_pe_b_peij_3_3_U16 ( .A1(i_data[1]), .A2(fc_pe_b_peij_3_3_n36), 
  ...
  INV_X1 fc_count_U23 ( .A(fc_count_N9), .ZN(fc_count_n23) );
  OAI22_X1 fc_count_U22 ( .A1(tb_en_cnt1), .A2(fc_count_n49), .B1(fc_count_n6), 
        .B2(fc_count_n23), .ZN(fc_count_n45) );
  INV_X1 fc_count_U21 ( .A(fc_count_N10), .ZN(fc_count_n22) );
  OAI22_X1 fc_count_U20 ( .A1(tb_en_cnt1), .A2(fc_count_n50), .B1(fc_count_n6), 
        .B2(fc_count_n22), .ZN(fc_count_n44) );
  INV_X1 fc_count_U19 ( .A(fc_count_N12), .ZN(fc_count_n20) );
  OAI22_X1 fc_count_U18 ( .A1(tb_en_cnt1), .A2(fc_count_n52), .B1(fc_count_n6), 
        .B2(fc_count_n20), .ZN(fc_count_n42) );
  INV_X1 fc_count_U17 ( .A(fc_count_N14), .ZN(fc_count_n18) );
  OAI22_X1 fc_count_U16 ( .A1(tb_en_cnt1), .A2(fc_count_n54), .B1(fc_count_n6), 
        .B2(fc_count_n18), .ZN(fc_count_n40) );
  INV_X1 fc_count_U15 ( .A(fc_count_N15), .ZN(fc_count_n17) );
  OAI22_X1 fc_count_U14 ( .A1(tb_en_cnt1), .A2(fc_count_n55), .B1(fc_count_n6), 
        .B2(fc_count_n17), .ZN(fc_count_n39) );
  NAND2_X1 fc_count_U13 ( .A1(tb_en_cnt1), .A2(fc_count_n46), .ZN(fc_count_n6)
         );
  INV_X1 fc_count_U12 ( .A(fc_out_mux[4]), .ZN(fc_count_n11) );
  OR2_X1 fc_count_U11 ( .A1(fc_count_n15), .A2(fc_out_mux[2]), .ZN(fc_count_n1) );
  INV_X1 fc_count_U10 ( .A(fc_out_mux[2]), .ZN(fc_count_n13) );
  ...
  NAND4_X1 fc_count2_U27 ( .A1(fc_cnt2_2_), .A2(fc_cnt2_1_), .A3(fc_count2_n11), .A4(fc_count2_n2), .ZN(fc_count2_n10) );
  AOI21_X1 fc_count2_U26 ( .B1(fc_count2_n6), .B2(fc_count2_n1), .A(
