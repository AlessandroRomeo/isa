...
analyze -f vhdl -lib WORK ../src/add_mult1.vhd
analyze -f vhdl -lib WORK ../src/add_mult2.vhd
analyze -f vhdl -lib WORK ../src/add_mult3.vhd
analyze -f vhdl -lib WORK ../src/add_mult4.vhd
analyze -f vhdl -lib WORK ../src/add_mult5.vhd
analyze -f vhdl -lib WORK ../src/fir_block_1_2.vhd
analyze -f vhdl -lib WORK ../src/fir_block_3.vhd
