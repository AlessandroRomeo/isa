...
analyze -f vhdl -lib WORK ../src/mbe_multiplier/param.vhd
analyze -f vhdl -lib WORK ../src/mbe_multiplier/mux2to1_n.vhd
analyze -f vhdl -lib WORK ../src/mbe_multiplier/mux3to1_n.vhd
analyze -f vhdl -lib WORK ../src/mbe_multiplier/half_adder.vhd
analyze -f vhdl -lib WORK ../src/mbe_multiplier/full_adder.vhd
analyze -f vhdl -lib WORK ../src/mbe_multiplier/booth_enc.vhd
analyze -f vhdl -lib WORK ../src/mbe_multiplier/parprod_gen.vhd
analyze -f vhdl -lib WORK ../src/mbe_multiplier/mbe_mul.vhd
