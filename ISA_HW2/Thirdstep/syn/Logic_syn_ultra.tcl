...
report_timing > ./Reports_compileultra/report_timing_fpmul.txt
report_area > ./Reports_compileultra/report_area_fpmul.txt
report_power > ./Reports_compileultra/report_power_fpmul.txt
report_resources > ./Reports_compileultra/report_resources_fpmul.txt
